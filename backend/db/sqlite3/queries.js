...
const DELETE_INJECTION_INFO_AND_AI_DATES_BY_ID_SQL = "DELETE FROM INJECTION_INFO_AND_AI_DATES WHERE ID = ?".toLowerCase();
const DELETE_INJECTION_INFO_AND_AI_DATES_BY_COW_ID_SQL = "DELETE FROM INJECTION_INFO_AND_AI_DATES WHERE COW_ID = ?".toLowerCase();
...
module.exports = {
  ...
  DELETE_INJECTION_INFO_AND_AI_DATES_BY_COW_ID_SQL
};